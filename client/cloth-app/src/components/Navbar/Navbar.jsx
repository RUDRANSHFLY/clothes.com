...
//                 <div className='cat'>
//                     <div className='item'>
//                         <Link onClick={() => { seticon(false) }} className='link' to='/products/2/'>Men</Link>
//                     </div>
//                     <div className='item'>
//                         <Link onClick={() => { seticon(false) }} className='link' to='/products/3/'>Women</Link>
//                     </div>
//                     <div className='item'>
//                         <Link onClick={() => { seticon(false) }} className='link' to='/products/1/'>Children</Link>
//                     </div>
    ...
    return (
        <>
            ...
            <div id='hm' className={
                ...
                <div className='cat'>
                    <div className='item'>
                        <Link onClick={() => { seticon(false) }} className='link' to='/products/1/'>Men</Link>
                    </div>
                    <div className='item'>
                        <Link onClick={() => { seticon(false) }} className='link' to='/products/2/'>Women</Link>
                    </div>
                    <div className='item'>
